...
const cacheModels = {} as Record<TrafficSignalType, Object3D>;

const modelFiles: Record<TrafficSignalType, string> = {
...
export default class TrafficSignalRender extends Target {
  ...
  static preloading() {
    ...
    for (key in modelFiles) {
      proms.push(TrafficSignalRender.initLoadModel(key));
    }
